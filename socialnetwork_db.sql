...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 23, 2019 lúc 05:01 PM
...
(13, '121212', '', 0, '2019-12-22 23:30:52', 0, 3);
...
(1, 'Hà Giang', 'zenkiben@gmail.com', '123456', '090000000', '1991-12-19', '1576417287.jpg', '', 1, '', '2019-12-03 00:00:00', '2019-12-14 09:55:19'),
...
CREATE TABLE `users_notifications` (
  ...
  `FromUserID` int(11) NOT NULL,
  `ToUserID` int(11) NOT NULL,
  `NotificationType` int(11) NOT NULL DEFAULT 0 COMMENT '0 - Yêu cầu kết bạn, 1 - Có tin nhắn',
...
--
ALTER TABLE `newfeeds`
  MODIFY `NewFeedID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
